            ...
            if message.author.voice:
                ...
                async with message.channel.typing():
                    if audio_name in audios and audios[audio_name].startswith("http"):
                        ...
                        voice_client.play(discord.FFmpegPCMAudio(audios[audio_name], **ffmpeg_options))
...
bot.run('MTIwNDUxMDc1NjcwODY4MzgyNg.GpRoIs.9VPDP7x0Zm-PoNF2aRVNHOYoGEV1Q2NlF2ZVXA')
